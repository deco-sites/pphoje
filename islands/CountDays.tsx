...
function CountDays() {
  ...
  return (
    <div>
        <div>
            <h1 class="text-center text-[36px]"> O app do Maior São João do Mundo em Campina Grande - PB</h1>
        </div>
        <div>
            {days > 0 ? (
                <h2 class="text-purple-300 text-center text-[36px]">faltam {days} dias</h2>
            ):(
                <h3 >Hoje Tem</h3>
            )}
        </div>
