  ...
  return (
    <div class="md:max-w-[800px] md:mx-auto" id="lineUp">
                ...
                <div>
                  ...
                  <ul>
                    {selectedPerformer?.icons &&
                      selectedPerformer?.icons.map((social, index) => {
                        <li>
      ...
      <div class="grid grid-cols-4">
        <ArtistList
          artists={almostGood}
          openModal={(index) => openDialog(index, "almost")}
        />
      </div>
      <div class="grid grid-cols-5">
        <ArtistList
          artists={otherSingers}
          openModal={(index) => openDialog(index, "other")}
        />
      </div>
      <div>
