                  ...
                  >
                    <div class="">
                      <div>
                        ...
                        <div>
                          <img src={selectedPerformer?.mobile} alt="" width={45} height={45} />
                        </div>
                        <div>
                          <div>
      ...
      <div>
        <div class="grid grid-cols-4">
          {almostGood.map((performer, index) => (
            <div key={index} class="cursor-pointer" onClick={() => { if (!isModalOpen) {openModal(index, 'almost')}}}>
              <div class="relative">
                <img src={performer.mobile}
                  alt=""
      ...
      <div>
        <div class="grid grid-cols-5">
          {otherSingers.map((performer, index) => (
             <div key={index} class="cursor-pointer" onClick={() => { if (!isModalOpen) {openModal(index, 'other')}}}>
              <div class="relative">
                <img
                  src={performer.mobile}
                  alt=""
