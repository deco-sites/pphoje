  ...
  return (
    <div>
        ...
        <div class="mx-4">
            {performers.map((artist, index) =>(
                <div class="flex items-center border-b-2 border-gray-400 border-solid py-2">
                    <div>
                        <img src={artist.mobile} alt="" width={60} height={60}
        ...
        <div class="flex justify-center items-center mt-2">
            <button class="bg-btn-default text-white py-2 px-2 rounded-[5px]">Programação completa</button>
            <button class="ml-2 bg-btn-default text-white py-2 px-2 rounded-[5px]">Line Up</button>
        </div>
    </div>
  )
}
