...
((e) => {
  ...
  const w = e.parent,
    ...
    C = (e, t, r, s, a) =>
      void 0 !== t && (s = typeof t)
        ? "string" === s || "number" === s || "boolean" === s || null == t
          ...
          ? r.has(t) ? [1, []] : r.add(t) && [1, t.map((t) => C(e, t, r))]
          : "object" === s
          ? x(t)
    ...
    U = "cssText,selectorText,href,media,namespaceURI,prefix,name,conditionText"
      .split(","),
    P = async (e, t) => {
      let n, i, s, o, a, l, c = { F: t.F }, u = r(t.Q), h = 0;
      for (; h < u; h++) {
        try {
          l = h === u - 1,
            n = t.Q[h],
            ...
            : (t.x || (t.x = 1,
              ((e, t, n) => {
                let i,
                  ...
                  l = (r, n) =>
                    e.postMessage([10, { V: t, q: r, b: C(t, Array.from(n)) }]);
                if (
                  n._ptf = void 0,
                    a.map((e) => {
                      s = n,
    ...
    H = () => {
      const e = Object.getOwnPropertyNames(w).map((e) =>
        ((e, t, r, n) => {
  ...
  (async (e) => {
    ...
    return (n, i) => {
      ...
      } else {2 === i[0] ? n.postMessage([3, H()]) : 11 === s
          ? e(o, (e) => {
    ...
    e &&
      (J = new Worker(
        ...
        w.addEventListener(
          "pt1",
          (e) => k(J, f(e.detail.frameElement), e.detail),
        ));
  });
})(window);
